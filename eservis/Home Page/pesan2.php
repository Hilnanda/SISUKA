<?php 
    ...
    $toko_servis = mysqli_query($mysqli,
    "SELECT * FROM toko_servis AS k 
    INNER JOIN user AS u 
    ON k.ID_USER = u.ID_USER 
    inner join kec  
    on kec.ID_KEC = u.ID_KEC 
    WHERE k.ID_TOKO = '$_GET[ID_TOKO]'");
 ?>
...
<body id="category">
    ...
    <div class="row m-5">
        <?php
            $show_toko_servis = mysqli_fetch_array($toko_servis);

        ?>
        <section class="bg-light" style="width:100%;">
            <h2 data-aos="fade-right" class="text-center p-3">Profile Toko <?php echo $show_toko_servis['USERNAME'];?></h2>
            <div class="half d-md-flex d-block">
                <div class="image rounded" data-aos="fade-left"
                    style="padding:10px; margin-left:200px; margin-top:10px;margin-right: 50px">
                    <img src="../admin_toko/images/<?php echo $show_toko_servis['FOTO_TOKO']; ?>" style="width: 300px">
                ...
                <form role="form" method="post" action="">
                    <dl data-aos="fade-right" data-aos-delay="100">
                        <!-- <input type="hidden" value="<?php echo $show_toko_servis['ID_KANG']; ?>" name="ID_KANG"> -->
                        
                        <dt style="font-size: 20px;">
                            <i class="fa fa-glide fa-fw"></i> Nama Toko
                        </dt>
                        <dd style="font-size: 20px;">
                            <?php echo $show_toko_servis['NAMA_TOKO']; ?>
                        </dd>
                        <dt style="font-size: 20px;">
                            <i class="fa fa-glide fa-fw"></i> Deskripsi Toko
                        </dt>
                        <dd style="font-size: 20px;">
                            <?php echo $show_toko_servis['DESKRIPSI_TOKO']; ?>
                        </dd>
                        ...
                        <dd style="font-size: 20px;">
                            <?php echo $show_toko_servis['EMAIL']; ?>
                        </dd>
                        <dt style="font-size: 20px;">
                            <i class="fa fa-book"></i> Nomor HP
                        </dt>
                        <dd style="font-size: 20px;">
                            <?php echo $show_toko_servis['NO_HP']; ?>
                        </dd>
                        ...
                        <dd style="font-size: 20px;">
                            <?php echo $show_toko_servis['ALAMAT_USER']; ?>
                        </dd>
                        <dt style="font-size: 20px;">
                            <i class="fa fa-map-marker fa-fw"></i> Kecamatan
                        </dt>
                        <dd style="font-size: 20px;">
                                <?php echo $show_toko_servis['NAMA_KEC']; ?>, Malang
                            </dd>
