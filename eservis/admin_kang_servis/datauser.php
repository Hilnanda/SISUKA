...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Penyervis
                    </h1>
            ...
            <main role="main" class="container">
                <div class="row">
                    <div class="col-md-7 blog-main text-right">
                        <dl>
                            <?php
                                $query5 = mysqli_query($mysqli, "SELECT * FROM kang_servis where ID_USER='$_SESSION[ID_USER]'");
                            ...
                            if($show5['NIK_KANG'] != null){
                                    ?>
                            <dt style="font-size: 20px;">
                                <i class="fa fa-address-card"></i> Keahlian 
                            </dt>
                            <dd style="font-size: 20px;">
                                <?php echo $show5['KEAHLIAN']; ?>
                            </dd>
                            <?php
                                }
                            ?>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <?php
                                                        ...
                                                        <label>NIK</label>
                                                        <input type="text" class="form-control" name="NIK_KANG"
                                                            value="<?php echo $show5['NIK_KANG']; ?>" />
                                                        <input type="hidden" class="form-control" name="ID_KANG"
                                                            value="<?php echo $show5['ID_KANG']; ?>" />
                                                    </div>
                                                            <?php
                                                                }
                                                            ?>
                                                    ...
                                                    <?php
                                                        ...
                                                        <textarea class="form-control" name="KEAHLIAN"
                                                            value=""><?php echo $show5['KEAHLIAN']; ?></textarea>
                                                    </div>
                                                            <?php
                                                                }
                                                            ?>
                                                    ...
                                                    <?php
                                                        ...
                                                        <select name="ID_KATEGORI" class="form-control" value="<?php echo $show5['ID_KATEGORI']; ?>">


                                                            <?php 

                                                        $query10 = mysqli_query($mysqli, "SELECT * FROM kategori_servis");

                                                        //perintah menampilkan semua stok di tabel jual dengan perulangan
                                                        


                                                        while ($dat = mysqli_fetch_array($query10)) {
                                                            # code...
                                                            if($dat['ID_KATEGORI']==$show5['ID_KATEGORI']){
                                                                ?>
                                                                <option selected="selected" value="<?php echo $dat['ID_KATEGORI']; ?>">
                                                                <?php echo $dat['NAMA_KATEGORI']; ?></option>
                                                                <?php
                            ...
                            <dd style="margin-top: 10px">
                                <?php 
                                    $query2 = mysqli_query($mysqli, "SELECT * FROM kang_servis where ID_USER='$_SESSION[ID_USER]'");
                                                        ...
                                                        while ($show = mysqli_fetch_array($query)) {
                                                         ...
                                                         ?>
                                                            <option value="<?php echo $show['ID_KATEGORI']; ?>">
                                                                <?php echo $show['NAMA_KATEGORI']; ?></option>
                    ...
                    <aside class="col-md-4 blog-sidebar">
                        <div class="p-3 mb-3 bg-light rounded">
                            <div class="text-center">
                                <?php 
                                    $query3 = mysqli_query($mysqli, "SELECT * FROM kang_servis where ID_USER='$_SESSION[ID_USER]'");

                                    //perintah menampilkan semua stok di tabel jual dengan perulangan
                                    
                                        
                                        $show4 = mysqli_fetch_array($query3);
                                    if($show4['FOTO_KANG']==NULL ){
                                        ...
                                        ?>
                                <img src="images/<?php echo $show4['FOTO_KANG']; ?>" height="300px" width="auto">
                                <?php
    ...
    <?php 
        include "koneksi.php";
            ...
            if (isset($_POST["updateuser"])) {
                ...
                $query1 = mysqli_query($mysqli, "UPDATE kang_servis SET NIK_KANG='$NIK_KANG', KEAHLIAN='$KEAHLIAN', ID_KATEGORI='$ID_KATEGORI' WHERE ID_USER='$ID_USER'") or die ("Sql salah : ".mysqli_error($mysqli));
                if($query){
        ...
        include "koneksi.php";
            if (isset($_POST["lengkapi"])) {
                ...
                if ($jumlah > 0) {
                    ...
                    $query = mysqli_query($mysqli, "INSERT INTO kang_servis VALUES(NULL,'$NIK_KANG' ,'$KEAHLIAN', '$ID_KATEGORI','$gambar[0]','$_SESSION[ID_USER]' )") or die ("Sql salah : ".mysqli_error($mysqli));
                    if($query){
