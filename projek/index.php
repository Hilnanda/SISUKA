...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: rgb(255, 26, 26)">
		<div class="container">
			...
			<form action="index.php" method="GET" style="margin-left: 50px">
				<td>
					<input type="text"  name="cari" style="border-radius: 5px;width: 400px;height: 33px" placeholder=" Aku ingin belanja sepatu...">
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-lg-7">
				...
				if (isset($_GET['cari'])) {
					$cari = $_GET['cari'];
					echo "<h3>Hasil Pencarian : <b>$cari</b></h3>";
				...
				<div class="row">
					...
					if (isset($_GET['cari'])) {
						...
						$stok = mysqli_query($mysqli,"SELECT * FROM stok WHERE nama_sepatu like '%$cari%' OR jenis like '%$cari%'");
					}
					else{
				...
				<div class="container">
					<div class="row" style="margin-bottom: 50px"> 
						<div class="col-lg-12">
							...
							<img src="cenger.jpg" style="width: 300px;border-radius: 20px;float: left;margin-right: 20px">
							<p><b>Belanja Online Sepatu Murah Hanya di Cenger's Sneaker</b></p>
							<p>Cenger's Sneaker merupakan situs belanja sepatu online terpercaya di Indonesia yang menjual beragam produk sepatu yang dibutuhkan seluruh masyarakat Indonesia. Seiring berkembangnya teknologi, semakin banyak aktivitas yang dilakukan secara digital, lebih mudah dan praktis, termasuk kegiatan pembelanjaan yang kini semakin marak dilakukan secara digital, baik melalui komputer, laptop, hingga smartphone yang bisa diakses kapan saja dan di mana saja. Cenger's Sneaker hadir sebagai toko sepatu online terpercaya dengan sistem konsumen ke konsumen. Hal ini memungkinkan setiap orang untuk membeli produk dengan mudah secara online. </p>
						</div>
					</div>
				</div>
