                                    ...
                                    <div class="col-12">
                                        ...
                                        <script>
                                            ...
                                            var myChart = new Chart(ctx, {
                                                type: 'bar',
                                                data: {
                                                    labels: ["Pasir", "Split", "Semen", "Batu"],
                                                    datasets: [{

                                                        label: ' Jumlah Data ',
                                                        data: [
                                                            <?php
                                                            $jumlah_pasir = mysqli_query($mysqli, "SELECT * from data where MATERIAL_ID='1'");
                                                            echo mysqli_num_rows($jumlah_pasir);
                                                            ?>,
                                                            <?php
                                                            $jumlah_split = mysqli_query($mysqli, "SELECT * from data where MATERIAL_ID='2'");
                                                            echo mysqli_num_rows($jumlah_split);
                                                            ?>,
                                                            <?php
                                                            $jumlah_semen = mysqli_query($mysqli, "SELECT * from data where MATERIAL_ID='3'");
                                                            echo mysqli_num_rows($jumlah_semen);
                                                            ?>,
                                                            <?php
                                                            $jumlah_batu = mysqli_query($mysqli, "SELECT * from data where MATERIAL_ID='4'");
                                                            echo mysqli_num_rows($jumlah_batu);
                                                            ?>
                                                        ],
                                                        backgroundColor: [
                                                            'rgba(255, 99, 132, 0.2)',
                                        ...
                                        <tbody>
                                            ...
                                            while ($show = mysqli_fetch_array($query1)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="laporan.php?tanggal=<?php echo $show['DATA_TANGGAL'] ?>"><i class="mdi mdi-send"></i></a>
